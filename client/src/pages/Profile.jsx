...
function Profile() {
  ...
  const [showListingsEror, setShowListingsEror] = useState(false);
  ...
  const handlewShowListing = async () => {
    try {
  ...
  return (
    <div className="p-3 max-w-lg-mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          disabled={loading}
          className="bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95 text-center"
        >
      ...
      <button onClick={handlewShowListing} className="text-green-700 w-full">
        Show Listings
      </button>
      <p className="text-red-700 mt-5">
        {showListingsEror ? "Error showing listings" : ""}
      </p>
      {userListings &&
